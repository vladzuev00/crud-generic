...
import by.nhorushko.crudgenerictest.mapper.TrackerAbsMapperDtoEntity;
...
public final class TrackerServiceCRUD extends AbsServiceCRUD<Long, TrackerEntity, Tracker, TrackerRepository> {
    public TrackerServiceCRUD(TrackerAbsMapperDtoEntity mapper, TrackerRepository repository) {
