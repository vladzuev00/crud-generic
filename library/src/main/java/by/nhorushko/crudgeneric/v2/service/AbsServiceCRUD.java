...
public abstract class AbsServiceCRUD<
        ...
        extends AbsServiceRUD<ENTITY_ID, ENTITY, DTO, AbsMapperDtoEntity<ENTITY, DTO>, REPOSITORY> {

    public AbsServiceCRUD(AbsMapperDtoEntity<ENTITY, DTO> mapper, REPOSITORY repository) {
